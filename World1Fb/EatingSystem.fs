...
type EatingSystem(game:Game, isActive:bool) =
    ...
    member private this.CheckCaloricUpdates r =
        ...
        |> Array.iter (fun ec -> game.EventManager.QueueEvent (Event_BurnCalories(ec.EntityID)))

    override this.Initialize = 
        game.EventManager.RegisterListener Action_Eat this.onEat
        game.EventManager.RegisterListener BurnCalories this.onMetabolize
        base.SetToInitialized

    override this.Update r = 
        this.CheckCaloricUpdates r