...
//            enm.UpdateComponent (Controller (controller.Update None (Some newAction) None None))
...
//            enm.UpdateComponent (Controller (c.Update None None (Some current) (Some potential)))
