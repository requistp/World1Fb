...
//            enm.UpdateComponent (Mating (mc.Update None None (Some round) None)) 
//            match chance >= rnd with
//            | false -> 
//                enm.UpdateComponent (Mating (mc2.Update None None (Some round) None))
...
//                enm.UpdateComponent (Mating (mc2.Update None (Some Female_Pregnant) (Some round) None)) 
...
//        enm.UpdateComponent (Mating (m.Update None (Some Female) (Some (round + m.Species.MaxMatingFrequency)) None)) // Change Mom to Non-Pregnant Female and add some extra time to before she can mate again
