...
//        match lc.EntityID |> EntityExt.TryGetComponent enm VisionComponentID with
...
//            enm.UpdateComponent (Vision (v.ToVision.Update round None (Some viewableMap) (Some visionMap)))
//            Ok None
