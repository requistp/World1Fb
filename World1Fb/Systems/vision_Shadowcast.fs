...
//let ComputeVisibility2 (viewerLocation:LocationDataInt) (grid:LocationDataInt[]) (forms:Map<LocationDataInt,FormComponent[]>) (viewRadius:int) =
//    let mutable viewableMap = [|viewerLocation|]
...
//    viewableMap
//    //|> Array.fold (fun (m:Map<LocationDataInt,RoundNumber*ComponentID[]>) l -> m.Add(l, (round, forms.[l] |> Array.map (fun f -> f.ID))) ) Map.empty
