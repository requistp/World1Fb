...
let ComputeVisibility_Basic (grid:LocationDataInt[]) (forms:Map<LocationDataInt,FormComponent[]>) =
    grid 
    |> Array.fold (fun (m:Map<LocationDataInt,FormComponent[]>) l -> 
        m.Add(l,forms.Item(l))
        ) Map.empty


let ComputeVisibility_Shadowcast1 (viewerLocation:LocationDataInt) (grid:LocationDataInt[]) (forms:Map<LocationDataInt,FormComponent[]>) (viewRadius:int) =
    let mutable viewableMap = Map.empty<LocationDataInt,FormComponent[]>  
...
let ComputeVisibility_original (viewerLocation:LocationDataInt) (grid:LocationDataInt[]) (forms:Map<LocationDataInt,FormComponent[]>) (viewRadius:int) =
